            ...
            <div className='text-white bg-black grid gap-4 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 grid-rows-3 p-10' id='library'>
                ...
                <div className='border max-w-lg sm:max-w-md lg:max-w-sm rounded-lg overflow-hidden'>
                    ...
                    <div className='p-2 bg-slate-900'>
                        ...
                        <p className='text-gray-400 mt-2 flex justify-center text-sm'>Anthony Gidden's Sociology sixth edition.</p>
                    </div>
                ...
                <div className='border max-w-lg md:max-w-md lg:max-w-sm rounded-lg overflow-hidden'>
                    <img src={bookImage} alt='' className='w-full h-auto'/>
                    <div className='p-2 bg-slate-900'>
                        <h3 className='text-xl font-semibold flex justify-center'>Sociology</h3>
                        <p className='text-gray-400 mt-2 flex justify-center text-sm'>Anthony Gidden's Sociology sixth edition.</p>
